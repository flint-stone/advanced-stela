...
public class HengeFluidPredictionScheduler implements IScheduler {
    private static final Logger LOG = LoggerFactory.getLogger(HengeFluidPredictionScheduler.class);
...
*/
            ...
            if (receivers.size() > 0 && givers.size() > 0) {
                ...
                ArrayList<ExecutorPair> executorSummaries = selector.selectPairs(globalState, globalStatistics, receiver, giver);
