...
public class MatchingPredictionSelector implements Selector {
	...
	public ArrayList<ExecutorPair> selectPairs(GlobalState globalState, GlobalStatistics globalStatistics, ArrayList<String> targetIDs, ArrayList<String> victimIDs, Observer sloObserver){
        ...
        RankingStrategy victimStrategy = new ETPStrategy(victimSchedule, victimStatistics);
        ...
        //deep copy both target and victim list -> prepare for recursive method
        /*ArrayList<String> expectedTargetIDs = new ArrayList<String>();
        ArrayList<String> expectedVictimIDs = new ArrayList<String>();
        expectedTargetIDs.addAll(targetIDs);
        expectedVictimIDs.addAll(victimIDs);*/
        //ArrayList<ExecutorSummary> victimExecutorDetails = victimComponent.component.getExecutorSummaries();
        ...
        for(int i=0; i<targetIDs.size();i++){
            ...
            RankingStrategy targetStrategy = new ETPStrategy(targetSchedule, targetStatistics);
            ArrayList<ResultComponent> rankTarget = targetStrategy.executorRankDescending();
