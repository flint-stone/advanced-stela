...
public class HengeMatchingStaticScheduler implements IScheduler {
    private static final Logger LOG = LoggerFactory.getLogger(HengeMatchingStaticScheduler.class);
